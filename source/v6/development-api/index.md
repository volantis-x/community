...
源码参考：[`layout/_plugins/pjax/index.ejs`](https://github.com/volantis-x/hexo-theme-volantis/blob/6.x/layout/_plugins/pjax/index.ejs)
...
使用案例：[`layout/_plugins/pjax/animate.ejs`](https://github.com/volantis-x/hexo-theme-volantis/blob/5.x/layout/_plugins/pjax/animate.ejs#L27-L29)
...
使用案例：[`layout/_plugins/comments/utterances/script.ejs`](https://github.com/volantis-x/hexo-theme-volantis/blob/6.x/layout/_plugins/comments/utterances/script.ejs#L41)
