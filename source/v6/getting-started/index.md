...
{% note info :: 配置和使用 volantis 6.x 之前请确保 node.js 升级至 <emp>v22.x 及以上</emp>版本！ %}
...
{% note bug danger :: alpha 阶段的开发测试版本 和 beta 阶段的测试版本 我们统称为 「小白鼠测试版本」, 「小白鼠测试版本」 仅存在于 [Github 仓库的 6.x 分支](https://github.com/volantis-x/hexo-theme-volantis/tree/6.x) %}
...
{% endtimenode %}
{% timenode 第 3/3 步：将主题仓库切换为 6.x 分支 %}
