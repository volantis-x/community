...
- 必要条件
  - 使用主题至少一个月
  - 长期活跃于社区：留言评论或者解答求助帖、提交建设性 issue
- 可选条件
  - 发现和解决问题如提 issue 或者解答 issue 或者提交 PR
  - 完善官网文档、纠正文档错误、语病、翻译问题等
  - 发布相关文章并转载外链到官网或者直接在官网发布文章

如果您满足以上条件，可以在{% btn, 论坛, https://github.com/volantis-x/forum/issues %}发帖申请加入团队。

{% p subtitle, 团队成员可以干什么呢？ %}
