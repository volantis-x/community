...
```yaml blog/themes/volantis/_config.yml
plugins:
  instant_page: https://cdn.jsdelivr.net/gh/xaoxuu/cdn-volantis@1.7.1/js/instant_page.js
```
...
```yaml blog/themes/volantis/_config.yml
plugins:
  comment_typing: https://cdn.jsdelivr.net/gh/xaoxuu/cdn-volantis@1.7.1/js/comment_typing.js
```
